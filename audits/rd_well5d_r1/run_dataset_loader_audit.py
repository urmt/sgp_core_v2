...
- field names
- temporal dimensions
- successful extraction of 10 frames
"""
...
def main():
    print("RD-WELL.5D.R1 — Dataset Loader Audit")
    print("=" * 60)
    print("Goal: Make loading work for Rayleigh-Bénard, Active Matter, Rayleigh-Taylor")
    print("=" * 60)

    # Test different URL patterns for each dataset
    datasets = {
        'rayleigh_benard': [
            'https://huggingface.co/datasets/polymathic-ai/rayleigh_benard/resolve/main/data/train/rayleigh_benard_Ra1e+08_Pr1_2D_512x128_1000.hdf5',
            'https://huggingface.co/datasets/polymathic-ai/rayleigh_benard/resolve/main/data/train/rayleigh_benard_Ra1e+08_Pr1_2D_512x128_200.hdf5',
            'https://huggingface.co/datasets/polymathic-ai/rayleigh_benard/resolve/main/data/train/rayleigh_benard_Ra1e+06_Pr1_2D_512x128_1000.hdf5',
        ],
        'active_matter': [
            ...
            'https://huggingface.co/datasets/polymathic-ai/active_matter/resolve/main/data/train/active_matter_activity_0.1_noise_0.001.hdf5',
        ],
        'rayleigh_taylor': [
    ...
    output = {
        'description': 'Dataset loader audit',
        'results': results,
    }

    output_file = os.path.join(output_dir, "dataset_loader_audit.json")

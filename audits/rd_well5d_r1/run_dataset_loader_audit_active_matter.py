#!/usr/bin/env python3
"""
RD-WELL.5D.R1.2 — Dataset Loader Audit (Active Matter URLs)

Goal: Make loading work for Active Matter.
...
def main():
    print("RD-WELL.5D.R1.2 — Dataset Loader Audit (Active Matter URLs)")
    print("=" * 60)
    print("Goal: Make loading work for Active Matter")
    print("=" * 60)
    ...
    datasets = {
        'active_matter': [
            ...
            'https://huggingface.co/datasets/polymathic-ai/active_matter/resolve/main/data/train/active_matter_L_10.0_zeta_3.0_alpha_-1.0.hdf5',
            'https://huggingface.co/datasets/polymathic-ai/active_matter/resolve/main/data/train/active_matter_L_10.0_zeta_5.0_alpha_-1.0.hdf5',
        ],
    }
    ...
    output = {
        'description': 'Dataset loader audit (Active Matter URLs)',
        'results': results,
    }

    output_file = os.path.join(output_dir, "dataset_loader_audit_active_matter.json")

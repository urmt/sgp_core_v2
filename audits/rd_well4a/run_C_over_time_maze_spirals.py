#!/usr/bin/env python3
"""
RD-WELL.4A.1 — Compute C Over Time for Multiple Patterns
...
Now testing: maze and spirals patterns.
"""
...
def main():
    print("RD-WELL.4A.1 — Compute C Over Time for Multiple Patterns")
    print("=" * 60)
    print("Safe finding: Observed C increased across sampled windows in one dataset (bubbles).")
    print("Temporal relation to stabilization remains under investigation.")
    print("=" * 60)
    
    all_results = {}
    
    for pattern_name in ['maze', 'spirals']:
    ...
    output = {
        'description': 'C over time for maze and spirals',
        'results': all_results
    }
    
    output_file = os.path.join(output_dir, "C_over_time_maze_spirals.json")

#!/usr/bin/env python3
"""
RD-WELL.2 Blind Physics Reconnaissance - Time Series Analysis

Streams Gray-Scott data at multiple time steps to observe temporal changes.
"""
...
def main():
    print("RD-WELL.2 Blind Physics Reconnaissance - Time Series Analysis")
    print("=" * 60)
    ...
    output_file = os.path.join(output_dir, "gray_scott_time_series_observations.json")
